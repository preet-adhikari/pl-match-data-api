...
class CreateMatchStatisticsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('match_statistics', function (Blueprint $table) {
            ...
            $table->unsignedInteger("home_team_hit_woodwork")->nullable();
            $table->unsignedInteger("away_team_hit_woodwork")->nullable();
            ...
            $table->unsignedInteger("home_team_offsides")->nullable();
            $table->unsignedInteger("away_team_offsides")->nullable();
